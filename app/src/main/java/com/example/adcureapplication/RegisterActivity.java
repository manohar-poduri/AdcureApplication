...
public class RegisterActivity extends AppCompatActivity {
    private EditText emailReg,pswrdRed,repswrdreg,phoneReg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repswrdreg=(EditText)findViewById(R.id.register_re_pswrd);
         mAuth=FirebaseAuth.getInstance();  currentUser=mAuth.getCurrentUser();
    ...
    private void createUserAccount() {
        ...
        if(TextUtils.isEmpty(email)&& TextUtils.isEmpty(pswrd)   && TextUtils.isEmpty(repswrd)){
            Toast toast=Toast.makeText(this, "Please fill the details.", Toast.LENGTH_SHORT);
            View view=toast.getView();
            view.setBackgroundResource(R.color.design_default_color_primary_dark);
            toast.show();
        }else if(TextUtils.isEmpty(email)){
            emailReg.setError("Please write your MailId");
         }else if(!(email).contains("@gmail.com")){
            emailReg.setError("Please write your Correct MailId");
         }
      else if(TextUtils.isEmpty(pswrd) && TextUtils.isEmpty(repswrd)){
          pswrdRed.setError("Please write your Password");
          repswrdreg.setError( "Please write your Password");
            Toast.makeText(this, "Please write your Password", Toast.LENGTH_SHORT).show();
        }else if(!(pswrd.equals(repswrd))){
          pswrdRed.setError("Password and confirm password does not match");
            repswrdreg.setError("Password and confirm password does not match");
